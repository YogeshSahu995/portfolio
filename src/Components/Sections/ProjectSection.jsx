                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="max-w-[90vw] md:max-w-[50vw] mx-auto">
                        <Carousel>
                            ...
                            <div className="flex justify-between w-[50vw] mx-auto my-4">
                                <Button 
                                    value="Demo"
                                    icon={<i class="ri-arrow-right-up-line"></i>}
                                />
                                <Button 
                                    value="Source"
                                    icon={<i class="ri-arrow-right-up-line"></i>}
                        ...
                        <div className="flex flex-col items-center gap-3 mt-3 border p-2 rounded bg-[#00000049]">
